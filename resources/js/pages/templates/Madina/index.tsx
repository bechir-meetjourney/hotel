 ...
 */
export default function Madina({ tenant, hotelSettings, contactSettings, rooms, gallery, siteTexts, activeSections, templateTranslations, locale }: Props) {
  ...
  return (
    ...
    >
      {/* Hero section / slider */}
      {shouldShow('hero') && <HeroSection />}

      {/* SVG decoration after the slider */}
      ...
      {/* Gallery slider */}
      {shouldShow('gallery') && <GallerySlider gallery={gallery} />}
