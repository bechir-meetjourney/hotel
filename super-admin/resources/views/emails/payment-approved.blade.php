                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="font-size:14px;color:#666;margin:0 0 16px;">
                                يسعدنا إبلاغك بأنه تم مراجعة إيصال الدفع الخاص بك والموافقة عليه.
                                حسابك الآن <strong style="color:#059669;">مفعّل</strong> ويمكنك البدء في إدارة منشأتك.
                            </p>
                            ...
                            <div style="text-align:center;margin:24px 0;">
                                <a href="{{ config('app.client_url', 'http://localhost:8000') }}/login"
